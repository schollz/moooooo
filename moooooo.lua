...
function init()
  ...
  for i = 1, global_num_loops do
    global_loops[i] = looper_:new({id=i, midi_names=midi_names, midi_device=midi_device})
  end
  params:default()
  params:bang()
  ...
  for i, md in ipairs(midi_device) do
    ...
    md.event = function(data)
      ...
      print(i .. " " .. midi_names[i] .. " type", d.type, "ch", d.ch, "indevice", params:get("looper_midi_in_device"),
            "in channel", params:get("looper_midi_in_channel"))
